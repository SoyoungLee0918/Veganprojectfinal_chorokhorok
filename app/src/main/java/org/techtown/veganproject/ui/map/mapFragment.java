...
public class mapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onActivityResult(ActivityResultEvent activityResultEvent){
        ...
        marker_name = activityResultEvent.getData().getStringExtra("marker_name");
        marker_lat = activityResultEvent.getData().getDoubleExtra("marker_lat",0);
        marker_lon=activityResultEvent.getData().getDoubleExtra("marker_lon",0);
        Log.d("확인을 해보자",marker_name);
        Log.d("확인을 해보자", String.valueOf(marker_lat));
        Log.d("확인을 해보자", String.valueOf(marker_lon));
    }
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                moveCameraToKml(marker_name,marker_lat,marker_lon);
   ...
   public void moveCameraToKml(String marker_name, final Double marker_lat, Double marker_lon){
       if (marker_name!=null&&marker_lat!=null&&marker_lon!=null){

           Log.d("즐겨찾기 들어갔는지 확인을 하자","잘된듯");
           final LatLng latLng_bookmark = new LatLng(marker_lat,marker_lon);
           mMap.setOnMapLoadedCallback(new GoogleMap.OnMapLoadedCallback() {
               @Override
               public void onMapLoaded() {
                   CameraUpdate cameraUpdate = CameraUpdateFactory.newLatLngZoom(latLng_bookmark,15);
                   MarkerOptions markerOptions = new MarkerOptions();
                   markerOptions.position(latLng_bookmark);
                   markerOptions.title("즐겨찾기를 찾으신 장소입니다.");
                   markerOptions.snippet("마커를 클릭하여 정보를 확인하세요");
                   markerOptions.draggable(true);
